//REFER TO "Elevator.java" FOR THE UPDATED CODE WITHOUT LATCHES
...
public class OldElevator {
	...
	public OldElevator(int leftelevatormotor, int rightelevatormotor, int encoderportA, int encoderportB, int limitswitchport, Latches latches) {
